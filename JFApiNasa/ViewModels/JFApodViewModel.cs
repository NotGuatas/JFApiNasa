...
namespace JFApiNasa.ViewModels;

public class JFApodViewModel : INotifyPropertyChanged
{
 ...
 public DateTime ChosenDate
    ...
    private JFApodService service;
    public JFApodService Service
    {
        get
        {
            if (service == null)
            {
                service = new JFApodService();
            }
            return service;
        }
    }
    ...
    {
        JFApod dto = await Service.GetImage(day);
        if (dto == null)
        {
